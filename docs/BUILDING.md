...
FluentTB/
  ...
  Outputs/
    2026.3.11.0/
      ...
      FluentTB-Public-2026.3.11.0-x64.msi
      FluentTB-Public-2026.3.11.0-x64-Setup.exe
      FluentTB-Public-2026.3.11.0-x64.msix
      SHA256.json
```
...
./Update-Version.ps1 -NewVersion 2026.3.11.0
