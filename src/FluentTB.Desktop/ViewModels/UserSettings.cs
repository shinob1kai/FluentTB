...
{
    public int FluentTBMigrationVersion { get; set; }
    ...
    [ObservableProperty]
    public partial int? MediaFlyoutSelectedMonitor { get; set; }
    ...
    [ObservableProperty]
    public partial bool TaskbarWidgetFollowAlignment { get; set; }
    ...
    /// <summary>Null follows the Windows multimedia output; otherwise a persistent endpoint ID.</summary>
    [ObservableProperty]
    public partial string? TaskbarVisualizerDeviceId { get; set; }
    ...
    public UserSettings()
    {
        ...
        TaskbarWidgetFollowAlignment = true;
        ...
        TaskbarVisualizerDeviceId = null;
    ...
    {
        if (oldValue == newValue || _initializing) return;
        TaskbarVisualizerControl.RefreshCapture();
    ...
    partial void OnTaskbarVisualizerDeviceIdChanged(string? oldValue, string? newValue)
    {
        if (oldValue == newValue || _initializing) return;
        TaskbarVisualizerControl.RefreshDevice();
    }
