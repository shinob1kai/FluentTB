...
public class OnboardingViewModel : ObservableObject
{
    ...
    [
        new OnboardingStep
        {
            Title = Application.Current.TryFindResource("FtbTaskbarTitle").ToString(),
            Description = Application.Current.TryFindResource("FtbTaskbarDescription").ToString(),
            ImageSource = "/Resources/FluentTBDemoFloatingTaskbar.png"
        },
        new OnboardingStep
        {
    ...
    public bool IsMediaStep => CurrentStepIndex == 1;

    public bool IsVolumeStep => CurrentStepIndex == 2;

    public bool IsLockKeysStep => CurrentStepIndex == 3;

    public bool IsPremiumStep => CurrentStepIndex == 4;
