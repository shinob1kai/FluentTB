...
internal static class ThemeManager
{
    ...
    public static void UpdateTrayIcon()
    {
        Application.Current.Dispatcher.Invoke(() =>
        {
            ...
            {
                // Tray artwork is independent of the Dev app logo and the app's theme.
                ...
                var iconUri = new Uri(systemTheme == WindowsThemeDetector.ThemeMode.Dark
                    ? "pack://application:,,,/Resources/TrayIcons/TrayDark.png"
                    : "pack://application:,,,/Resources/TrayIcons/TrayLight.png");
