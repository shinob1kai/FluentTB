...
namespace FluentTB
{
    public class Types
    {
        ...
        {
            public bool TaskbarShapeEnabled { get; set; } = true;
            ...
            // Preserve Windows' visible Widgets button unless explicitly disabled.
            public bool ShowWidgets       { get; set; } = true;
            public bool ShowClock         { get; set; }
            public bool ShowSegmentsOnHover { get; set; }
            public bool MusicWidgetEnabled { get; set; }
            public bool MusicWidgetShowArtist { get; set; } = true;
            public bool MusicWidgetControls { get; set; } = true;
            public bool MusicWidgetHideWhenIdle { get; set; } = true;
            public bool MusicWidgetAllMonitors { get; set; } = true;
            ...
            public Settings Clone()
            {
                return new Settings
                {
                    TaskbarShapeEnabled = this.TaskbarShapeEnabled,
                    ...
                    MusicWidgetEnabled = this.MusicWidgetEnabled,
                    MusicWidgetShowArtist = this.MusicWidgetShowArtist,
                    MusicWidgetControls = this.MusicWidgetControls,
                    MusicWidgetHideWhenIdle = this.MusicWidgetHideWhenIdle,
                    MusicWidgetAllMonitors = this.MusicWidgetAllMonitors,
                };
            }
        }
